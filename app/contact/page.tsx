...
export default function Contact() {
    ...
    return (
        <main className="bg-stone-50 min-h-screen text-stone-900 overflow-x-hidden w-full block">
            <div className="w-full max-w-screen-2xl mx-auto px-6 md:px-12 pt-32 pb-16 md:pb-32 border-b border-stone-300 flex flex-col justify-center items-center">
            ...
            <div className="w-full max-w-screen-2xl mx-auto px-6 md:px-12 py-24 lg:py-40">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-24 lg:gap-0 items-start">
                    <div className="lg:col-span-5 flex flex-col gap-16">
                        <CustomDiv label="Contact Details" />
                            ...
                            {isSent ? (
                                ...
                                <form onSubmit={handleSubmit} className="flex flex-col gap-12 w-full">
                                    ...
                                    <button
                                        ...
                                        className="mt-8 self-center md:self-start px-12 py-6 bg-stone-900 text-stone-50 font-mono font-bold tracking-widest uppercase text-sm md:text-base hover:bg-stone-700 active:scale-95 transition-all disabled:opacity-50"
                                    >
