    ...
    return (
        <section className="overflow-x-hidden">
            <PortfolioAbstract
                ...
                content={{"Some description about the photo one": "/capycalm_banner.png", "Some description about the photo two": "/pfp.jpeg", "Some description about the photo three": "/capycalm_banner.png", "Some description about the photo four": "/pfp.jpeg"}}
            />
        </section>
    );
}